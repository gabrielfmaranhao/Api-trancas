...
const deleteBraidsService = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!findBraid) {
        throw new errors_1.AppError(401, "Tranca não encontrada");
    }
    yield braidsRepository.delete({ id: findBraid.id });
});
exports.default = deleteBraidsService;
